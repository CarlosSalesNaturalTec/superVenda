...
- Fornecedores
- Produtos (com foto, código de barras, Grupo e Subgrupo, preço normal, preço carnê)
...
- Lançar contas a receber (carnês)
...
- Dashboard com Gráficos de vendas por periodo, produto
